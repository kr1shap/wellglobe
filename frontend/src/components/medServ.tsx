...
function EmerMedCard(prop: props) {
  return (
    <div className="bg-[#E9F7FF] rounded-xl border-[3px] border-[#000000] p-6 w-[600px] h-[240px] shadow-sm">
      {/* Title aligned top-left */}
      <p className="text-sm font-bold text-[#000055] mb-4">
      ...
      <div className="flex flex-row justify-around items-center">
        ...
        <div className="flex flex-col items-center text-center">
          <i className="bi bi-fire text-[50px] text-[#27005D] mb-1"></i>
        ...
        {/* Ambulance */}
        <div className="flex flex-col items-center text-center">
          <i className="bi bi-hospital text-[50px] text-[#27005D] mb-1"></i>
        ...
        {/* Police */}
        <div className="flex flex-col items-center text-center">
          <i className="bi bi-shield-shaded text-[50px] text-[#27005D] mb-1"></i>
